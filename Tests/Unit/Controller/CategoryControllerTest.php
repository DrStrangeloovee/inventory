...
{
    /**
     * @var \VendorInventory\Vendorinventoryadvanced\Controller\CategoryController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\VendorInventory\Vendorinventoryadvanced\Controller\CategoryController::class)
    ...
    public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView()
    {
        ...
        $categoryRepository = $this->getMockBuilder(\VendorInventory\Vendorinventoryadvanced\Domain\Repository\CategoryRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $category = new \VendorInventory\Vendorinventoryadvanced\Domain\Model\Category();
